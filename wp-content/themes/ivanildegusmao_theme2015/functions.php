...
function html5blank_header_scripts()
{
    if ($GLOBALS['pagenow'] != 'wp-login.php' && !is_admin()) {
        ...
        wp_register_script('jquery', get_template_directory_uri() . '/script/jquery-1.9.1.js', array('jquery'), '1.0.0'); // Custom scripts
        wp_enqueue_script('jquery'); // Enqueue it!

        wp_register_script('jqueryuijs', get_template_directory_uri() . '/script/jquery-ui-1.10.3.custom.js', array('jquery'), '1.0.0'); // Custom scripts
        wp_enqueue_script('jqueryuijs'); // Enqueue it!

        wp_register_script('bxslider', get_template_directory_uri() . '/script/jquery.bxslider.min.js', array('jquery'), '1.0.0'); // Custom scripts
...
function html5blank_styles()
{
    ...
    wp_register_style('resetcss', get_template_directory_uri() . '/style/reset.css', array(), '1.0', 'all');
    wp_enqueue_style('resetcss'); // Enqueue it!
    ...
    wp_register_style('typo', get_template_directory_uri() . '/typo/typo.css', array(), '1.0', 'all');
    wp_enqueue_style('typo'); // Enqueue it!

    wp_register_style('bxslider', get_template_directory_uri() . '/style/jquery.bxslider.css', array(), '1.0', 'all');
